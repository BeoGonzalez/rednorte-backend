...
/**
 * Exception thrown when a requested patient-domain resource cannot be found in
 * the persistence layer.
 * <p>
 * This exception should be used for missing patients or future resources owned
 * by the patients microservice. The {@link ResponseStatus} annotation documents
 * the intended HTTP mapping, while {@link GlobalExceptionHandler} builds the
