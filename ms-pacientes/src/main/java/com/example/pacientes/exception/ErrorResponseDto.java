...
/**
 * Standard error response returned by the patients microservice.
 * <p>
 * This DTO provides a stable contract for the BFF, API Gateway, frontend
 * clients, and other microservices that consume patient-domain endpoints. The
 * {@code details} map is intended for field-level validation errors or safe
 * contextual information that can be exposed to API consumers.
 * </p>
 *
