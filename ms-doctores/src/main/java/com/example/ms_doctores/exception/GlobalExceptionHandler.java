...
/**
 * Centralized exception handler for the doctors microservice REST API.
 * <p>
...
public class GlobalExceptionHandler {
    ...
    /**
     * Handles requests for doctor-domain resources that do not exist.
     *
    ...
    /**
     * Handles doctor-domain business rule violations.
     *
    ...
    /**
     * Handles database integrity conflicts such as duplicate auth IDs or medical
     * license numbers.
     * <p>
    ...
    public ResponseEntity<ErrorResponseDto> handleDataIntegrityViolation(
        ...
        return ResponseEntity.status(status)
                .body(ErrorResponseDto.of(
                        status.value(),
                        status.getReasonPhrase(),
                        "Ya existe un doctor con los datos únicos informados.",
                        request.getRequestURI()
                ));
    }
